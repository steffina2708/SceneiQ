"""
video_engine/object_detector.py
Runs YOLOv8n (nano — fastest CPU model) on extracted frames.
...
# COCO class names we care about for event building
RELEVANT_CLASSES = {
...
MIN_BOX_AREA = 0.015      # 1.5% of frame
PERSON_TRACK_ONLY = False  # track ALL classes for full motion intelligence
HIGH_MOTION_CONF = 0.5
LOW_MOTION_CONF = 0.35
...
class ObjectDetector:
    """
    Wraps Ultralytics YOLOv8n for frame-level object detection.
    Model is loaded once and reused across all frames.
    """

    MODEL_NAME = "yolov8s.pt"   # better accuracy, still CPU safe
    ...
    def detect_batch(
        ...
        Args:
            ...
            batch_size: How many frames to process at once.
                        Default is 4 (safe for CPU; prevents OOM on long videos).
