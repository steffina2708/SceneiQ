"""
video_engine/frame_extractor.py
...
def extract_frames_adaptive(
    ...
    This means high-action segments are sampled more densely while static shots
    are sampled sparsely, reducing overall frame count and downstream latency
    compared to a fixed 1-fps approach.
